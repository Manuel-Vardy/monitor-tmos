...
export const schoolAuditLog = [
  {
    time: "08:14:03",
    who: "Abena Asante",
    role: "Accounts Officer",
    action: "Fee payment recorded · GHS 1,200.00",
    target: "RCP-2024-0841",
    branch: "Main Campus",
    type: "payment",
  },
  {
    ...
    who: "Kofi Mensah",
    role: "Registrar",
    action: "Student enrolled · IT Department",
    target: "STU-20240112",
    branch: "Main Campus",
    type: "registration",
  },
  {
    ...
    who: "System",
    role: "Trite PSP",
    action: "Automated settlement posted",
    target: "STL-0078",
    branch: "Organisation",
    type: "settlement",
  },
  {
    ...
    who: "Efua Boadu",
    role: "Accounts Officer",
    action: "Tuition fee edited · 3,500 → 3,800",
    target: "FEE-IT-2024",
    branch: "Main Campus",
    type: "fee-edit",
  },
  ...
  },
  {
    ...
    who: "Ama Owusu",
    role: "Admin",
    action: "Permission granted · Accounts Officer",
    target: "user_0134",
    branch: "Organisation",
    type: "permission",
  },
  {
    ...
    who: "Kwame Frimpong",
    role: "Registrar",
    action: "Student department changed · HR → IT",
    target: "STU-20230997",
    branch: "Main Campus",
    type: "registration",
  },
  {
    ...
    who: "Abena Asante",
    role: "Accounts Officer",
    action: "Partial payment recorded · GHS 600.00",
    target: "RCP-2024-0845",
    branch: "Main Campus",
    type: "payment",
  },
  {
    ...
    who: "System",
    role: "Scheduler",
    action: "Overdue balance alert sent · 42 students",
    target: "BATCH-2024-AUG",
    branch: "Organisation",
    type: "settlement",
  },
  {
    ...
    who: "Mr. Osei Bonsu",
    role: "Head of Department",
    action: "New sub-course added · Cybersecurity & Networks",
    target: "DEPT-IT",
    branch: "Organisation",
    type: "fee-edit",
  },
  {
    ...
    who: "Abena Asante",
    role: "Accounts Officer",
    action: "Fee payment reversed",
    target: "RCP-2024-0839",
    branch: "Main Campus",
    type: "refund",
  },
];
